...
// sql.select('name, age', 'customers', 'name', 'John')
//sql.insert('customers', ['name', 'age'])
//sql.update('customers', 'age', '30', 'name', 'chuks')
//console.log(sql.delete('customers', 'status', 'expired'));
module.exports = ORM;